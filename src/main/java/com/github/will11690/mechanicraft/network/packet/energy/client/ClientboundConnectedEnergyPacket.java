...
public class ClientboundConnectedEnergyPacket {
    ...
    public ClientboundConnectedEnergyPacket(int energyStored, int energyCapacity,  BlockPos blockPos, UUID playerUUID) {
    	validMessage = true;
        this.energyStored = energyStored;
        this.energyCapacity = energyCapacity;
        ClientboundConnectedEnergyPacket.blockPos = blockPos;
        this.playerUUID = playerUUID;
    }
    
    public static ClientboundConnectedEnergyPacket decode(PacketBuffer buffer) {
        return new ClientboundConnectedEnergyPacket(buffer.readInt(), buffer.readInt(), buffer.readBlockPos(), buffer.readUUID());
    }
    ...
    public static void onMessageReceived(final ClientboundConnectedEnergyPacket message, Supplier<NetworkEvent.Context> ctxSupplier) {
    ...
    private static void processMessage(ClientboundConnectedEnergyPacket message, Supplier<NetworkEvent.Context> ctxSupplier) {

...
public class T5EnergyChuteNetwork {

	private final HashSet<BlockPos>	connections;
	private final World	world;

	public T5EnergyChuteNetwork(final World world) {
	...
	public T5EnergyChuteNetwork add(final BlockPos connection) {
		
		this.getConnections().add(connection);
		return this;
	}

	public T5EnergyChuteNetwork remove(final BlockPos connection) {
	...
	public boolean equals(final Object obj) {
		...
		return (obj instanceof T5EnergyChuteNetwork) && ((T5EnergyChuteNetwork) obj).getConnections().equals(this.getConnections());
	}
		...
		for (final BlockPos pos : this.getConnections()) {
			...
			try {
				if (!hashedDontDistribute.contains(pos)) {
					...
					if(this.world.getBlockEntity(pos) instanceof TileEntityT5EnergyChute) {

...
import com.github.will11690.mechanicraft.blocks.chute.energychute.tier1.extractor.ScreenT1EnergyExtractor;
...
public final class ContainerTypeHandler {
    ...
    //CHUTES EXTRACTOR AND INSERTER
    //T1
    public static final RegistryObject<ContainerType<ContainerT1EnergyExtractor>> CONTAINER_T1_ENERGY_EXTRACTOR = register("container_t1_energy_extractor", ContainerT1EnergyExtractor::new);
    ...
    public static void registerScreens(FMLClientSetupEvent event) {
        ...
        //CHUTES EXTRACTOR AND INSERTER
        //T1
        ScreenManager.register(CONTAINER_T1_ENERGY_EXTRACTOR.get(), ScreenT1EnergyExtractor::new);

...
public class T6EnergyCubeNetwork {

	private final HashSet<BlockPos>	connections;
	private final World	world;

	public T6EnergyCubeNetwork(final World world) {
	...
	public T6EnergyCubeNetwork add(final BlockPos connection) {
		
		this.getConnections().add(connection);
		return this;
	}

	public T6EnergyCubeNetwork remove(final BlockPos connection) {
	...
	public boolean equals(final Object obj) {
		...
		return (obj instanceof T6EnergyCubeNetwork) && ((T6EnergyCubeNetwork) obj).getConnections().equals(this.getConnections());
	}
		...
		for (final BlockPos pos : this.getConnections()) {
			...
			try {
				if (!hashedDontDistribute.contains(pos)) {
					...
					if(this.world.getBlockEntity(pos) instanceof TileEntityT6EnergyCube) {

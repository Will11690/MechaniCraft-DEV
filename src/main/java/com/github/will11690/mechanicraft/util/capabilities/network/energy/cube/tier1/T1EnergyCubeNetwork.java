...
public class T1EnergyCubeNetwork {

	private final HashSet<BlockPos>	connections;
	private final World	world;

	public T1EnergyCubeNetwork(final World world) {
	...
	public T1EnergyCubeNetwork add(final BlockPos connection) {
		
		this.getConnections().add(connection);
		return this;
	}

	public T1EnergyCubeNetwork remove(final BlockPos connection) {
	...
	public boolean equals(final Object obj) {
		...
		return (obj instanceof T1EnergyCubeNetwork) && ((T1EnergyCubeNetwork) obj).getConnections().equals(this.getConnections());
	}
		...
		for (final BlockPos pos : this.getConnections()) {
			...
			try {
				if (!hashedDontDistribute.contains(pos)) {
					...
					if(this.world.getBlockEntity(pos) instanceof TileEntityT1EnergyCube) {

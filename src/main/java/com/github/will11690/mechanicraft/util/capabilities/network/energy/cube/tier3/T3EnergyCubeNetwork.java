...
public class T3EnergyCubeNetwork {

	private final HashSet<BlockPos>	connections;
	private final World	world;

	public T3EnergyCubeNetwork(final World world) {
	...
	public T3EnergyCubeNetwork add(final BlockPos connection) {
		
		this.getConnections().add(connection);
		return this;
	}

	public T3EnergyCubeNetwork remove(final BlockPos connection) {
	...
	public boolean equals(final Object obj) {
		...
		return (obj instanceof T3EnergyCubeNetwork) && ((T3EnergyCubeNetwork) obj).getConnections().equals(this.getConnections());
	}
		...
		for (final BlockPos pos : this.getConnections()) {
			...
			try {
				if (!hashedDontDistribute.contains(pos)) {
					...
					if(this.world.getBlockEntity(pos) instanceof TileEntityT3EnergyCube) {

...
public class T5EnergyCubeNetwork {

	private final HashSet<BlockPos>	connections;
	private final World	world;

	public T5EnergyCubeNetwork(final World world) {
	...
	public T5EnergyCubeNetwork add(final BlockPos connection) {
		
		this.getConnections().add(connection);
		return this;
	}

	public T5EnergyCubeNetwork remove(final BlockPos connection) {
	...
	public boolean equals(final Object obj) {
		...
		return (obj instanceof T5EnergyCubeNetwork) && ((T5EnergyCubeNetwork) obj).getConnections().equals(this.getConnections());
	}
		...
		for (final BlockPos pos : this.getConnections()) {
			...
			try {
				if (!hashedDontDistribute.contains(pos)) {
					...
					if(this.world.getBlockEntity(pos) instanceof TileEntityT5EnergyCube) {

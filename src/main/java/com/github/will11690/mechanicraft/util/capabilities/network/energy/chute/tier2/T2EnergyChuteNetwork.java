...
public class T2EnergyChuteNetwork {

	private final HashSet<BlockPos>	connections;
	private final World	world;

	public T2EnergyChuteNetwork(final World world) {
	...
	public T2EnergyChuteNetwork add(final BlockPos connection) {
		
		this.getConnections().add(connection);
		return this;
	}

	public T2EnergyChuteNetwork remove(final BlockPos connection) {
	...
	public boolean equals(final Object obj) {
		...
		return (obj instanceof T2EnergyChuteNetwork) && ((T2EnergyChuteNetwork) obj).getConnections().equals(this.getConnections());
	}
		...
		for (final BlockPos pos : this.getConnections()) {
			...
			try {
				if (!hashedDontDistribute.contains(pos)) {
					...
					if(this.world.getBlockEntity(pos) instanceof TileEntityT2EnergyChute) {

...
public class T6EnergyChuteNetwork {

	private final HashSet<BlockPos>	connections;
	private final World	world;

	public T6EnergyChuteNetwork(final World world) {
	...
	public T6EnergyChuteNetwork add(final BlockPos connection) {
		
		this.getConnections().add(connection);
		return this;
	}

	public T6EnergyChuteNetwork remove(final BlockPos connection) {
	...
	public boolean equals(final Object obj) {
		...
		return (obj instanceof T6EnergyChuteNetwork) && ((T6EnergyChuteNetwork) obj).getConnections().equals(this.getConnections());
	}
		...
		for (final BlockPos pos : this.getConnections()) {
			...
			try {
				if (!hashedDontDistribute.contains(pos)) {
					...
					if(this.world.getBlockEntity(pos) instanceof TileEntityT6EnergyChute) {

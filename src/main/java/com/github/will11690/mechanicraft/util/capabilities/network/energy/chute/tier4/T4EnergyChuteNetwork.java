...
public class T4EnergyChuteNetwork {

	private final HashSet<BlockPos>	connections;
	private final World	world;

	public T4EnergyChuteNetwork(final World world) {
	...
	public T4EnergyChuteNetwork add(final BlockPos connection) {
		
		this.getConnections().add(connection);
		return this;
	}

	public T4EnergyChuteNetwork remove(final BlockPos connection) {
	...
	public boolean equals(final Object obj) {
		...
		return (obj instanceof T4EnergyChuteNetwork) && ((T4EnergyChuteNetwork) obj).getConnections().equals(this.getConnections());
	}
		...
		for (final BlockPos pos : this.getConnections()) {
			...
			try {
				if (!hashedDontDistribute.contains(pos)) {
					...
					if(this.world.getBlockEntity(pos) instanceof TileEntityT4EnergyChute) {

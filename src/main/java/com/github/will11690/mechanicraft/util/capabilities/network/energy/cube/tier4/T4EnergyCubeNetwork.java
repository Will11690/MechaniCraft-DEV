...
public class T4EnergyCubeNetwork {

	private final HashSet<BlockPos>	connections;
	private final World	world;

	public T4EnergyCubeNetwork(final World world) {
	...
	public T4EnergyCubeNetwork add(final BlockPos connection) {
		
		this.getConnections().add(connection);
		return this;
	}

	public T4EnergyCubeNetwork remove(final BlockPos connection) {
	...
	public boolean equals(final Object obj) {
		...
		return (obj instanceof T4EnergyCubeNetwork) && ((T4EnergyCubeNetwork) obj).getConnections().equals(this.getConnections());
	}
		...
		for (final BlockPos pos : this.getConnections()) {
			...
			try {
				if (!hashedDontDistribute.contains(pos)) {
					...
					if(this.world.getBlockEntity(pos) instanceof TileEntityT4EnergyCube) {

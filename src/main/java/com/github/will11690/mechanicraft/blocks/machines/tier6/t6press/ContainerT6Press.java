package com.github.will11690.mechanicraft.blocks.machines.tier6.t6press;
...
public class ContainerT6Press extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT6Press tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT6Press(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
        this((TileEntityT6Press) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(15));
        
    }

    public ContainerT6Press(@Nullable TileEntityT6Press tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T6_PRESS.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 1, 34, 15) {
        	
        	@Override
        	public boolean mayPlace(ItemStack stack) {
        		
        		if(TileEntityT6Press.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 2, 54, 11) {
        	
        	@Override
        	public boolean mayPlace(ItemStack stack) {
        		
        		if(TileEntityT6Press.isRecipeInput2(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 3, 74, 15) {
        	
        	@Override
        	public boolean mayPlace(ItemStack stack) {
        		
        		if(TileEntityT6Press.isRecipeInput3(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 78, 35) {
        	
        	@Override
        	public boolean mayPlace(ItemStack stack) {
        		
        		if(TileEntityT6Press.isRecipeInput4(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 74, 55) {
        	
        	@Override
        	public boolean mayPlace(ItemStack stack) {
        		
        		if(TileEntityT6Press.isRecipeInput5(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 6, 54, 59) {
        	
        	@Override
        	public boolean mayPlace(ItemStack stack) {
        		
        		if(TileEntityT6Press.isRecipeInput6(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 7, 34, 55) {
        	
        	@Override
        	public boolean mayPlace(ItemStack stack) {
        		
        		if(TileEntityT6Press.isRecipeInput7(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 8, 30, 35) {
        	
        	@Override
        	public boolean mayPlace(ItemStack stack) {
        		
        		if(TileEntityT6Press.isRecipeInput8(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 9, 54, 35) {
        	
        	@Override
        	public boolean mayPlace(ItemStack stack) {
        		
        		if(TileEntityT6Press.isRecipeInput9(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 10, 152, 4) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 11, 152, 24) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 12, 152, 44) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 13, 152, 64) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 14, 127, 36) {
    ...
    private static final int TE_INVENTORY_SLOT_COUNT = 15;  //must match TileEntityInventoryBasic.NUMBER_OF_SLOTS

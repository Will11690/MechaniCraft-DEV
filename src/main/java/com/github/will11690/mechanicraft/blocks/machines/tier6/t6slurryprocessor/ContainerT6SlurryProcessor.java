...
public class ContainerT6SlurryProcessor extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT6SlurryProcessor tile;
    ...
    public ContainerT6SlurryProcessor(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT6SlurryProcessor) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(6));
    	
    }
    
    public ContainerT6SlurryProcessor(@Nullable TileEntityT6SlurryProcessor tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T6_SLURRY_PROCESSOR.get(), id);
        ...
        this.addSlot(new SlotUpgrade(this.handler, 0, 152, 4) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 1, 152, 24) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 2, 152, 44) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 3, 152, 64) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 103, 32) {
    ...
    private IFluidHandler getFluid1() {
    	//INPUT 1
    	return tile.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, tile.getBlockState().getValue(T6SlurryProcessor.FACING).getClockWise()).orElse(null);
    }
    
    private IFluidHandler getFluid2() {
    	//INPUT 2
    	return tile.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, tile.getBlockState().getValue(T6SlurryProcessor.FACING).getCounterClockWise()).orElse(null);
    }
    
    private IFluidHandler getFluid3() {
    	//OUTPUT
    	return tile.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, tile.getBlockState().getValue(T6SlurryProcessor.FACING).getOpposite()).orElse(null);
    }

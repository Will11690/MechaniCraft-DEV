...
public class ContainerT4Crusher  extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT4Crusher tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT4Crusher(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
        this((TileEntityT4Crusher) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(6));
        
    }

    public ContainerT4Crusher(@Nullable TileEntityT4Crusher tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T4_CRUSHER.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 1, 50, 32) {
        	...
        	public boolean mayPlace(ItemStack input) {
        		...
        		Optional<CrusherRecipes> recipe = TileEntityT4Crusher.getRecipeForInput(tile.getLevel(), input);
        		
        		if(recipe.isPresent() && !(ItemStack.matches(TileEntityT4Crusher.getResultForItem(tile.getLevel(), input), input))) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 2, 152, 23) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 3, 152, 43) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 116, 32) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 116, 56) {

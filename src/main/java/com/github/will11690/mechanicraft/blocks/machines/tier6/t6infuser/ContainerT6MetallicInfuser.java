...
public class ContainerT6MetallicInfuser extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT6MetallicInfuser tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT6MetallicInfuser(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT6MetallicInfuser) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(8));
    	
    }
    
    public ContainerT6MetallicInfuser(@Nullable TileEntityT6MetallicInfuser tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T6_METALLIC_INFUSER.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 34, 29) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT6MetallicInfuser.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 6, 62, 29) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT6MetallicInfuser.isRecipeInput2(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 7, 128, 29) {

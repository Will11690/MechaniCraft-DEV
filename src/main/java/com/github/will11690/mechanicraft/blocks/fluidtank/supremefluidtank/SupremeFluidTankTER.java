...
@OnlyIn(Dist.CLIENT)
public class SupremeFluidTankTER extends TileEntityRenderer<TileEntitySupremeFluidTank> {

	public SupremeFluidTankTER(TileEntityRendererDispatcher dispatcher) {
	...
	@Override
	public void render(TileEntitySupremeFluidTank tank, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer renderBuffer, int combinedLight, int combinedOverlay) {

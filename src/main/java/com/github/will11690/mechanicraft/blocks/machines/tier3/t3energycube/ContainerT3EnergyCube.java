...
public class ContainerT3EnergyCube extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private TileEntityT3EnergyCube tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT3EnergyCube(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
        this((TileEntityT3EnergyCube) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), id, playerInventory, new ItemStackHandler(8));
        
    }

    public ContainerT3EnergyCube(@Nullable TileEntityT3EnergyCube tile, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
        super(ContainerTypeHandler.CONTAINER_T3_ENERGY_CUBE.get(), id);
        ...
        this.addSlot(new SlotEnergyItem(this.handler, 0, 53, 16));
        
        this.addSlot(new SlotEnergyItem(this.handler, 1, 53, 35));
        
        this.addSlot(new SlotEnergyItem(this.handler, 2, 53, 54));
        
        this.addSlot(new SlotEnergyItem(this.handler, 3, 107, 16));
        
        this.addSlot(new SlotEnergyItem(this.handler, 4, 107, 35));
        
        this.addSlot(new SlotEnergyItem(this.handler, 5, 107, 54));
        
        this.addSlot(new SlotStorageUpgrade(this.handler, 6, 152, 25) {
        ...
        this.addSlot(new SlotStorageUpgrade(this.handler, 7, 152, 45) {

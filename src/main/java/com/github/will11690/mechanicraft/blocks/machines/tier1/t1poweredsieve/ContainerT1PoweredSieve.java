...
public class ContainerT1PoweredSieve extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT1PoweredSieve tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT1PoweredSieve(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT1PoweredSieve) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(5));
    	
    }
    
    public ContainerT1PoweredSieve(@Nullable TileEntityT1PoweredSieve tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T1_POWERED_SIEVE.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 1, 62, 24) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT1PoweredSieve.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 2, 62, 43) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT1PoweredSieve.isRecipeInput2(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 3, 122, 24) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 122, 48) {

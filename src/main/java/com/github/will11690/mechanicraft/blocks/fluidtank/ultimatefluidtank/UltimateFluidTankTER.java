...
@OnlyIn(Dist.CLIENT)
public class UltimateFluidTankTER extends TileEntityRenderer<TileEntityUltimateFluidTank> {

	public UltimateFluidTankTER(TileEntityRendererDispatcher dispatcher) {
	...
	@Override
	public void render(TileEntityUltimateFluidTank tank, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer renderBuffer, int combinedLight, int combinedOverlay) {

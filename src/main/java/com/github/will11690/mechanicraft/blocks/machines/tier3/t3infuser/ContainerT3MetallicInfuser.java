...
public class ContainerT3MetallicInfuser extends Container {
    ...
    public ContainerT3MetallicInfuser(@Nullable TileEntityT3MetallicInfuser tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T3_METALLIC_INFUSER.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 2, 34, 29) {
            ...
            public boolean mayPlace(ItemStack stack) {
            	...
            	if(TileEntityT3MetallicInfuser.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 3, 62, 29) {
            ...
            public boolean mayPlace(ItemStack stack) {
            	...
            	if(TileEntityT3MetallicInfuser.isRecipeInput2(tile.getLevel(), stack)) {

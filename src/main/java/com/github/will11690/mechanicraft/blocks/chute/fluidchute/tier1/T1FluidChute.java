...
public class T1FluidChute extends Block {
	...
	public T1FluidChute(Properties properties) {
	...
	public static boolean canChuteConnectChute(IBlockReader world, BlockPos pos, Direction facing) {
		...
		if(neighborBlock == ModBlocks.T1_FLUID_CHUTE.get()) {
	...
	public static boolean canChuteConnectBlock(IBlockReader world, BlockPos pos, Direction facing) {
		...
		if(neighborBlock.hasTileEntity(neighborState) && neighborEntity.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, facing).isPresent() && neighborBlock != ModBlocks.T1_FLUID_CHUTE.get()) {
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		...
		return TileEntityHandler.TILE_ENTITY_T1_FLUID_CHUTE.get().create();

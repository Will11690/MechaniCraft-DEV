package com.github.will11690.mechanicraft.blocks.machines.tier6.t6infuser;
...
public class TileEntityT6MetallicInfuser extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int infusingEnergy = ModConfigs.t6InfuserEnergyPerTickInt/*PER TICK*/;
	private int WORK_TIME = ModConfigs.t6InfuserWorkTimeInt;
		
	private static int capacity = ModConfigs.t6InfuserCapacityInt;
	private static int receive = ModConfigs.t6InfuserReceiveInt;
    ...
    public TileEntityT6MetallicInfuser() {
    	
        super(TileEntityHandler.TILE_ENTITY_T6_METALLIC_INFUSER.get());
    ...
    public void tick() {
        ...
        if(canCraft() && this.level.getBlockState(this.worldPosition).getValue(T6MetallicInfuser.LIT) == false) {
        ...
        if(!canCraft() && this.level.getBlockState(this.worldPosition).getValue(T6MetallicInfuser.LIT) == true) {
        	
        	this.level.setBlockAndUpdate(this.worldPosition, this.level.getBlockState(this.worldPosition).setValue(T6MetallicInfuser.LIT, Boolean.valueOf(false)));
    ...
    private void setUpgradeModifiers() {
    	...
    	if(upgrade.isPresent()) {
    		...
    		if(progress == 0) {
        		...
        		upgradeHandler.fourUpgradeModifier(WORK_TIME, infusingEnergy, upgradeSlotHandler.getStackInSlot(0), upgradeSlotHandler.getStackInSlot(1), upgradeSlotHandler.getStackInSlot(2), upgradeSlotHandler.getStackInSlot(3));
	...
	public ITextComponent getDisplayName() {
		...
		return new TranslationTextComponent("container.mechanicraft.t6_metallic_infuser");
    ...
    public Container createMenu(int id, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        ...
        assert level != null;
		return new ContainerT6MetallicInfuser(this, this.fields, id, playerInventory, new CombinedInvWrapper(upgradeSlotHandler, chargeSlotHandler, inputSlotHandler1, inputSlotHandler2, outputSlotHandler));
    ...
    public void load(BlockState state, CompoundNBT tags) {
        ...
        this.inputSlotHandler1.deserializeNBT(tags.getCompound("inputSlot6"));
    ...
    public CompoundNBT save(CompoundNBT tags) {
        ...
        tags.put("inputSlot6", inputSlotHandler1.serializeNBT());

...
public class BasicFluidTank extends Block {
	...
	TileEntityBasicFluidTank tile;
	
	public BasicFluidTank(Properties properties) {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        ...
        return TileEntityHandler.TILE_ENTITY_BASIC_FLUID_TANK.get().create();
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult result) {
    	...
    	if (!world.isClientSide) {
            ...
            tile = (TileEntityBasicFluidTank) world.getBlockEntity(pos);

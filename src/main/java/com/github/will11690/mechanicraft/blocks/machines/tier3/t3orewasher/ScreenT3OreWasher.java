...
public class ScreenT3OreWasher extends ContainerScreen<ContainerT3OreWasher> {
	
    public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID, "textures/gui/ore_washer/t3_ore_washer.png");
    ...
    public ScreenT3OreWasher(ContainerT3OreWasher container, PlayerInventory playerInventory, ITextComponent title) {
    ...
    public void render(MatrixStack matrixStack, int x, int y, float partialTicks) {
        ...
        if(Screen.hasShiftDown()) {
        	...
        	if (x > (getGuiLeft() + INFO_INPUT_FLUID_TO_X) && x < (getGuiLeft() + INFO_INPUT_FLUID_TO_X) + INFO_INPUT_FLUID_WIDTH && y > (getGuiTop() + INFO_INPUT_FLUID_TO_Y) && y < (getGuiTop() + INFO_INPUT_FLUID_TO_Y) + INFO_INPUT_FLUID_HEIGHT) {
            	...
            	new TranslationTextComponent("com.github.will11690.mechanicraft.screen.t3_ore_washer.fluid_amount_stored_full", inputStored, inputCapacity))), x, y);
        	...
        	if (x > (getGuiLeft() + INFO_OUTPUT_FLUID_TO_X) && x < (getGuiLeft() + INFO_OUTPUT_FLUID_TO_X) + INFO_OUTPUT_FLUID_WIDTH && y > (getGuiTop() + INFO_OUTPUT_FLUID_TO_Y) && y < (getGuiTop() + INFO_OUTPUT_FLUID_TO_Y) + INFO_OUTPUT_FLUID_HEIGHT) {
            	...
            	new TranslationTextComponent("com.github.will11690.mechanicraft.screen.t3_ore_washer.fluid_amount_stored_full", outputStored, outputCapacity))), x, y);
        	...
        	if (x > (getGuiLeft() + INFO_PROGRESS_METER_TO_X) && x < (getGuiLeft() + INFO_PROGRESS_METER_TO_X) + INFO_PROGRESS_METER_WIDTH && y > (getGuiTop() + INFO_PROGRESS_METER_TO_Y) && y < (getGuiTop() + INFO_PROGRESS_METER_TO_Y) + INFO_PROGRESS_METER_HEIGHT) {
            	...
            	this.renderTooltip(matrixStack, LanguageMap.getInstance().getVisualOrder(Arrays.asList(
            	new TranslationTextComponent("com.github.will11690.mechanicraft.screen.t3_ore_washer.cook_progress", this.menu.getProgress(), this.menu.getMaxProgress()))), x, y);
			...
			if (x > (getGuiLeft() + INFO_ENERGY_BAR_TO_X) && x < (getGuiLeft() + INFO_ENERGY_BAR_TO_X) + INFO_ENERGY_BAR_WIDTH && y > (getGuiTop() + INFO_ENERGY_BAR_TO_Y) && y < (getGuiTop() + INFO_ENERGY_BAR_TO_Y) + INFO_ENERGY_BAR_HEIGHT) {
				...
				this.renderTooltip(matrixStack, LanguageMap.getInstance().getVisualOrder(Arrays.asList(
				new TranslationTextComponent("com.github.will11690.mechanicraft.screen.t3_ore_washer.energy", this.menu.getEnergyStored(), this.menu.getEnergyCapacity())
				)), x, y);
        	...
        	if (x > (getGuiLeft() + INFO_INPUT_FLUID_TO_X) && x < (getGuiLeft() + INFO_INPUT_FLUID_TO_X) + INFO_INPUT_FLUID_WIDTH && y > (getGuiTop() + INFO_INPUT_FLUID_TO_Y) && y < (getGuiTop() + INFO_INPUT_FLUID_TO_Y) + INFO_INPUT_FLUID_HEIGHT) {
            	...
            	this.renderTooltip(matrixStack, LanguageMap.getInstance().getVisualOrder(Arrays.asList(
            	new StringTextComponent(inputFluidStored),
            	new TranslationTextComponent("com.github.will11690.mechanicraft.screen.t3_ore_washer.fluid_amount_stored", Math.round(inputStored / 1000), Math.round(inputCapacity / 1000)),
        	...
        	if (x > (getGuiLeft() + INFO_OUTPUT_FLUID_TO_X) && x < (getGuiLeft() + INFO_OUTPUT_FLUID_TO_X) + INFO_OUTPUT_FLUID_WIDTH && y > (getGuiTop() + INFO_OUTPUT_FLUID_TO_Y) && y < (getGuiTop() + INFO_OUTPUT_FLUID_TO_Y) + INFO_OUTPUT_FLUID_HEIGHT) {
            	...
            	this.renderTooltip(matrixStack, LanguageMap.getInstance().getVisualOrder(Arrays.asList(
            	new StringTextComponent(outputFluidStored),
            	new TranslationTextComponent("com.github.will11690.mechanicraft.screen.t3_ore_washer.fluid_amount_stored", Math.round(outputStored / 1000), Math.round(outputCapacity / 1000)),
        		new TranslationTextComponent("com.github.will11690.mechanicraft.screen.gui_details"))), x, y);
        	...
        	if (x > (getGuiLeft() + INFO_PROGRESS_METER_TO_X) && x < (getGuiLeft() + INFO_PROGRESS_METER_TO_X) + INFO_PROGRESS_METER_WIDTH && y > (getGuiTop() + INFO_PROGRESS_METER_TO_Y) && y < (getGuiTop() + INFO_PROGRESS_METER_TO_Y) + INFO_PROGRESS_METER_HEIGHT) {
            	...
            	this.renderTooltip(matrixStack, LanguageMap.getInstance().getVisualOrder(Arrays.asList(
            	new TranslationTextComponent("com.github.will11690.mechanicraft.screen.t3_ore_washer.cook_progress", Utils.withSuffix(this.menu.getProgress()), Utils.withSuffix(this.menu.getMaxProgress())),
        		new TranslationTextComponent("com.github.will11690.mechanicraft.screen.gui_details"))), x, y);
			...
			if (x > (getGuiLeft() + INFO_ENERGY_BAR_TO_X) && x < (getGuiLeft() + INFO_ENERGY_BAR_TO_X) + INFO_ENERGY_BAR_WIDTH && y > (getGuiTop() + INFO_ENERGY_BAR_TO_Y) && y < (getGuiTop() + INFO_ENERGY_BAR_TO_Y) + INFO_ENERGY_BAR_HEIGHT) {
				...
				this.renderTooltip(matrixStack, LanguageMap.getInstance().getVisualOrder(Arrays.asList(
	        	new TranslationTextComponent("com.github.will11690.mechanicraft.screen.t3_ore_washer.energy", Utils.withSuffix(this.menu.getEnergyStored()), Utils.withSuffix(this.menu.getEnergyCapacity())),
	        	new TranslationTextComponent("com.github.will11690.mechanicraft.screen.gui_details"))), x, y);

...
public class ContainerAdvancedFurnace  extends Container {
    ...
    private TileEntityAdvancedFurnace tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerAdvancedFurnace(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
        this((TileEntityAdvancedFurnace) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(3), id, playerInventory, new ItemStackHandler(7));
        
    }

    public ContainerAdvancedFurnace(@Nullable TileEntityAdvancedFurnace tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_ADVANCED_FURNACE.get(), id);
        ...
        this.addSlot(new SlotUpgrade(this.handler, 1, 152, 23) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 2, 152, 43) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 3, 54, 19) {
        	
        	@Override
        	public boolean mayPlace(ItemStack input) {
        		
        		Optional<FurnaceRecipe> recipe = TileEntityAdvancedFurnace.getRecipeForInput1(tile.getLevel(), input);
        		
        		if(recipe.isPresent() && !(ItemStack.matches(TileEntityAdvancedFurnace.getResultForItem1(tile.getLevel(), input), input))) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 54, 46) {
    	
        	@Override
    		public boolean mayPlace(ItemStack input) {
    		
    			Optional<FurnaceRecipe> recipe = TileEntityAdvancedFurnace.getRecipeForInput2(tile.getLevel(), input);
    		
    			if(recipe.isPresent() && !(ItemStack.matches(TileEntityAdvancedFurnace.getResultForItem2(tile.getLevel(), input), input))) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 116, 19) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 6, 116, 46) {
    ...
    private boolean canExtractSpeedorEfficiency() {
    	...
    	return tile.upgradeHandler.canExtractFromSlot(this.fields.get(0) + this.fields.get(1));
    }
	...
	public int getProgressionScaled1() {
		
		int cookProgress = this.getProgress1();
		int cookTimeForRecipe = this.fields.get(2);
		return cookTimeForRecipe != 0 && cookProgress != 0 ? cookProgress * 24 / cookTimeForRecipe : 0;
		
	}

	public int getProgressionScaled2() {
		
		int cookProgress = this.getProgress2();
		int cookTimeForRecipe = this.fields.get(2);
		return cookTimeForRecipe != 0 && cookProgress != 0 ? cookProgress * 24 / cookTimeForRecipe : 0;

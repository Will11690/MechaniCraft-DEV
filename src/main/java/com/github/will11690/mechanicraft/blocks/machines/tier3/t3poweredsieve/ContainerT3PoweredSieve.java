...
public class ContainerT3PoweredSieve extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT3PoweredSieve tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT3PoweredSieve(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT3PoweredSieve) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(6));
    	
    }
    
    public ContainerT3PoweredSieve(@Nullable TileEntityT3PoweredSieve tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T3_POWERED_SIEVE.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 2, 62, 24) {
            ...
            public boolean mayPlace(ItemStack stack) {
            	...
            	if(TileEntityT3PoweredSieve.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 3, 62, 43) {
            ...
            public boolean mayPlace(ItemStack stack) {
            	...
            	if(TileEntityT3PoweredSieve.isRecipeInput2(tile.getLevel(), stack)) {

...
public class ContainerAdvancedCoalGenerator extends Container {
    ...
    private TileEntityAdvancedCoalGenerator tile;
    ...
    public ContainerAdvancedCoalGenerator(int id, PlayerInventory playerInventory, PacketBuffer exData) {
        ...
        this((TileEntityAdvancedCoalGenerator) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), id, playerInventory, new ItemStackHandler(4));
        
    }

    public ContainerAdvancedCoalGenerator(@Nullable TileEntityAdvancedCoalGenerator tile, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
        super(ContainerTypeHandler.CONTAINER_ADVANCED_COAL_GENERATOR.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 1, 80, 31) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 2, 151, 24) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 3, 151, 44) {
    ...
    private boolean canExtractSpeedorEfficiency() {
    	...
    	return tile.upgradeHandler.canExtractFromSlot(tile.burnTime);
    }

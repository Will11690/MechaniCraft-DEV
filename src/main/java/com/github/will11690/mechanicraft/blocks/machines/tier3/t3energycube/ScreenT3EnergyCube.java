...
public class ScreenT3EnergyCube extends ContainerScreen<ContainerT3EnergyCube> {
	
	private static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MOD_ID + ":textures/gui/energy_cube/t3energy_cube.png");
    ...
    public ScreenT3EnergyCube(ContainerT3EnergyCube container, PlayerInventory playerInventory, ITextComponent title) {

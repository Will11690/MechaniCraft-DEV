...
@OnlyIn(Dist.CLIENT)
public class EliteFluidTankTER extends TileEntityRenderer<TileEntityEliteFluidTank> {

	public EliteFluidTankTER(TileEntityRendererDispatcher dispatcher) {
	...
	@Override
	public void render(TileEntityEliteFluidTank tank, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer renderBuffer, int combinedLight, int combinedOverlay) {

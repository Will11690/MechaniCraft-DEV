...
public class T1EnergyInserter extends Block {
	...
	public T1EnergyInserter(Properties properties) {
	...
	//TODO Handler neighbor being an extractor
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader reader) {
        ...
        return TileEntityHandler.TILE_ENTITY_T1_ENERGY_INSERTER.get().create();
    }

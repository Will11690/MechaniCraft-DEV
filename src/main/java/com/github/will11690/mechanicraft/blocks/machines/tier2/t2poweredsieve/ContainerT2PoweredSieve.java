...
public class ContainerT2PoweredSieve extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT2PoweredSieve tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT2PoweredSieve(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT2PoweredSieve) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(6));
    	
    }
    
    public ContainerT2PoweredSieve(@Nullable TileEntityT2PoweredSieve tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T2_POWERED_SIEVE.get(), id);
        ...
        this.addSlot(new SlotUpgrade(this.handler, 0, 153, 22) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 2, 62, 24) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT2PoweredSieve.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 3, 62, 43) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT2PoweredSieve.isRecipeInput2(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 122, 24) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 122, 48) {

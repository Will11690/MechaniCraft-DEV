...
@OnlyIn(Dist.CLIENT)
public class BasicFluidTankTER extends TileEntityRenderer<TileEntityBasicFluidTank> {

	public BasicFluidTankTER(TileEntityRendererDispatcher dispatcher) {
	...
	@Override
	public void render(TileEntityBasicFluidTank tank, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer renderBuffer, int combinedLight, int combinedOverlay) {

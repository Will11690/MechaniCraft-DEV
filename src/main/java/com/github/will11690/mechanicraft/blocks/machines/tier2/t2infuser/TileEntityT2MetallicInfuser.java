...
public class TileEntityT2MetallicInfuser extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int infusingEnergy = ModConfigs.t2InfuserEnergyPerTickInt/*PER TICK*/;
	private int WORK_TIME = ModConfigs.t2InfuserWorkTimeInt;
		
	private static int capacity = ModConfigs.t2InfuserCapacityInt;
	private static int receive = ModConfigs.t2InfuserReceiveInt;

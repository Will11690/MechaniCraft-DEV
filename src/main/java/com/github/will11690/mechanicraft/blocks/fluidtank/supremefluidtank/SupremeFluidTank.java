...
public class SupremeFluidTank extends Block {
	...
	TileEntitySupremeFluidTank tile;
	
	public SupremeFluidTank(Properties properties) {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        ...
        return TileEntityHandler.TILE_ENTITY_SUPREME_FLUID_TANK.get().create();
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult result) {
    	...
    	if (!world.isClientSide) {
            ...
            tile = (TileEntitySupremeFluidTank) world.getBlockEntity(pos);

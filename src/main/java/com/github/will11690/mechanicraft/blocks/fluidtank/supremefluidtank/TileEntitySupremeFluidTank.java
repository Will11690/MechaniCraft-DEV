...
public class TileEntitySupremeFluidTank extends TileEntity implements ITickableTileEntity {
	...
	public void tick() {
		...
		if(this.getBlockState().getValue(SupremeFluidTank.OUTPUT_BOTTOM) == Boolean.valueOf(true)) {
	...
	void setOutputBottomTrue() {
		...
		if(this.getBlockState().getValue(SupremeFluidTank.OUTPUT_BOTTOM) == Boolean.valueOf(false)) {
			
			this.level.setBlockAndUpdate(this.worldPosition, this.level.getBlockState(this.worldPosition).setValue(SupremeFluidTank.OUTPUT_BOTTOM, Boolean.valueOf(true)));
		}
	}
	...
	void setOutputBottomFalse() {
		...
		if(this.getBlockState().getValue(SupremeFluidTank.OUTPUT_BOTTOM) == Boolean.valueOf(true)) {
			...
			this.level.setBlockAndUpdate(this.worldPosition, this.level.getBlockState(this.worldPosition).setValue(SupremeFluidTank.OUTPUT_BOTTOM, Boolean.valueOf(false)));
		}
	}

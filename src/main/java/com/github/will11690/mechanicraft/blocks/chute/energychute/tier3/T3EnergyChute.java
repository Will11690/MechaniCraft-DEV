...
public class T3EnergyChute extends Block {
	...
	public T3EnergyChute(Properties properties) {
	...
	public static boolean canChuteConnectChute(IBlockReader reader, BlockPos pos, Direction facing) {
		...
		if(neighborBlock == ModBlocks.T3_ENERGY_CHUTE.get()) {
	...
	public static boolean canChuteConnectBlock(IBlockReader reader, BlockPos pos, Direction direction) {
		...
		if(neighborBlock.hasTileEntity(neighborState) && neighborEntity.getCapability(CapabilityEnergy.ENERGY, direction.getOpposite()).isPresent() && neighborBlock != ModBlocks.T3_ENERGY_CHUTE.get()) {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader reader) {
        ...
        return TileEntityHandler.TILE_ENTITY_T3_ENERGY_CHUTE.get().create();
    }

...
public class TileEntityT5SlurryProcessor extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    private void setUpgradeModifiers() {
    	...
    	if(upgradeSlotHandler.getStackInSlot(0).getItem().equals(ModItems.CAPACITY_UPGRADE.get()) || upgradeSlotHandler.getStackInSlot(1).getItem().equals(ModItems.CAPACITY_UPGRADE.get()) ||
    		...
    		inputFluidTank1.upgradeCapacity(upgradeSlotHandler.getStackInSlot(0), upgradeSlotHandler.getStackInSlot(1), upgradeSlotHandler.getStackInSlot(2), ItemStack.EMPTY);
    		inputFluidTank2.upgradeCapacity(upgradeSlotHandler.getStackInSlot(0), upgradeSlotHandler.getStackInSlot(1), upgradeSlotHandler.getStackInSlot(2), ItemStack.EMPTY);

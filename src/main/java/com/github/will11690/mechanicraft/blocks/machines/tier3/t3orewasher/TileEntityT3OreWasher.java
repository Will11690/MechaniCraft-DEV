...
public class TileEntityT3OreWasher extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	...
	private int washingEnergy = ModConfigs.t3OreWasherEnergyPerTickInt/*PER TICK*/;
	private int WORK_TIME = ModConfigs.t3OreWasherWorkTimeInt;
		
	private static int capacity = ModConfigs.t3OreWasherEnergyCapacityInt;
	private static int receive = ModConfigs.t3OreWasherReceiveInt;
	private static int fluid_capacity = ModConfigs.t3OreWasherTankCapacityInt;

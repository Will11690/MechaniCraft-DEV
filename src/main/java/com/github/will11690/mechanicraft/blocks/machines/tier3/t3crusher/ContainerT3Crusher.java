...
public class ContainerT3Crusher  extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT3Crusher tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT3Crusher(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
        this((TileEntityT3Crusher) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(5));
        
    }

    public ContainerT3Crusher(@Nullable TileEntityT3Crusher tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T3_CRUSHER.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 1, 50, 32) {
        	...
        	public boolean mayPlace(ItemStack input) {
        		...
        		Optional<CrusherRecipes> recipe = TileEntityT3Crusher.getRecipeForInput(tile.getLevel(), input);
        		
        		if(recipe.isPresent() && !(ItemStack.matches(TileEntityT3Crusher.getResultForItem(tile.getLevel(), input), input))) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 3, 116, 32) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 116, 56) {

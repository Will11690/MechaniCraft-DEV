...
public class ContainerT4MetallicInfuser extends Container {
    ...
    public ContainerT4MetallicInfuser(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT4MetallicInfuser) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(6));

...
public class TileEntityT1PoweredSieve extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    public TileEntityT1PoweredSieve() {
    	
        super(TileEntityHandler.TILE_ENTITY_T1_POWERED_SIEVE.get());
    ...
    private void startCrafting() {
		...
		if(canCraft()) {
			...
			if(progress < WORK_TIME) {
				...
				++progress;
				energyStorage.consumeEnergy(sievingEnergy);
			}
	...
	public ITextComponent getDisplayName() {
		...
		return new TranslationTextComponent("container.mechanicraft.t1_powered_sieve");
    ...
    public Container createMenu(int id, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        ...
        assert level != null;
		return new ContainerT1PoweredSieve(this, this.fields, id, playerInventory, new CombinedInvWrapper(chargeSlotHandler, inputSlotHandler1, inputSlotHandler2, outputSlotHandler));
    ...
    public void load(BlockState state, CompoundNBT tags) {
		...
		this.sievingEnergy = tags.getInt("SievingEnergy");
    ...
    public CompoundNBT save(CompoundNBT tags) {
		...
		tags.putInt("SievingEnergy", sievingEnergy);

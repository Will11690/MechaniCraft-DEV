...
public class ContainerT2OreWasher extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT2OreWasher tile;
    ...
    public ContainerT2OreWasher(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	...
    	this((TileEntityT2OreWasher) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(3));
    	
    }
    
    public ContainerT2OreWasher(@Nullable TileEntityT2OreWasher tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T2_ORE_WASHER.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 2, 71, 31) {
            ...
            public boolean mayPlace(ItemStack stack) {
            	...
            	if(TileEntityT2OreWasher.isRecipeInputStack(tile.getLevel(), stack)) {
    ...
    private IFluidHandler getFluid2() {
    	...
    	return tile.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, tile.getBlockState().getValue(T2OreWasher.FACING).getOpposite()).orElse(null);
    }

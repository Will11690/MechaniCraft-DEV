...
public class ContainerT3OreWasher extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT3OreWasher tile;
    ...
    public ContainerT3OreWasher(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT3OreWasher) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(3));
    	
    }
    
    public ContainerT3OreWasher(@Nullable TileEntityT3OreWasher tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T3_ORE_WASHER.get(), id);
        ...
        this.addSlot(new SlotUpgrade(this.handler, 0, 155, 24) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 2, 71, 31) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT3OreWasher.isRecipeInputStack(tile.getLevel(), stack)) {
    ...
    private IFluidHandler getFluid2() {
    	...
    	return tile.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, tile.getBlockState().getValue(T3OreWasher.FACING).getOpposite()).orElse(null);
    }

...
public class ContainerT5MetallicInfuser extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT5MetallicInfuser tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT5MetallicInfuser(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT5MetallicInfuser) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(7));
    	
    }
    
    public ContainerT5MetallicInfuser(@Nullable TileEntityT5MetallicInfuser tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T5_METALLIC_INFUSER.get(), id);
        ...
        this.addSlot(new SlotUpgrade(this.handler, 0, 152, 13) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 1, 152, 33) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 2, 152, 53) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 34, 29) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT5MetallicInfuser.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 62, 29) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT5MetallicInfuser.isRecipeInput2(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 6, 128, 29) {

...
public class SuperiorFluidTank extends Block {
	...
	TileEntitySuperiorFluidTank tile;
	
	public SuperiorFluidTank(Properties properties) {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        ...
        return TileEntityHandler.TILE_ENTITY_SUPERIOR_FLUID_TANK.get().create();
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult result) {
    	...
    	if (!world.isClientSide) {
            ...
            tile = (TileEntitySuperiorFluidTank) world.getBlockEntity(pos);

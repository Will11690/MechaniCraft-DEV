...
public class UltimateFluidTank extends Block {
	...
	static final BooleanProperty OUTPUT_BOTTOM = BooleanProperty.create("output_bottom");
	...
	TileEntityUltimateFluidTank tile;
	
	public UltimateFluidTank(Properties properties) {
        ...
        this.registerDefaultState(this.stateDefinition.any()
        		...
        		.setValue(OUTPUT_BOTTOM, Boolean.valueOf(false)));
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        ...
        return TileEntityHandler.TILE_ENTITY_ULTIMATE_FLUID_TANK.get().create();
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult result) {
    	...
    	if(!world.isClientSide) {
            ...
            tile = (TileEntityUltimateFluidTank) world.getBlockEntity(pos);
            ...
            if(tileEntity != null) {
                ...
                if(player.isShiftKeyDown() && heldItem.isEmpty()) {
                	...
                	if(tile.getBlockState().getValue(OUTPUT_BOTTOM) == Boolean.valueOf(false)) {
                		
                		tile.setOutputBottomTrue();
                		player.level.playSound(null, playerPosition, SoundEvents.DISPENSER_FAIL, SoundCategory.PLAYERS, 1.0F, 1.0F);
                		
               		 	return ActionResultType.SUCCESS;
                	
                	} else if(tile.getBlockState().getValue(OUTPUT_BOTTOM) == Boolean.valueOf(true)) {
                		
                		tile.setOutputBottomFalse();
                		player.level.playSound(null, playerPosition, SoundEvents.DISPENSER_FAIL, SoundCategory.PLAYERS, 1.0F, 1.0F);
    ...
    protected void createBlockStateDefinition(StateContainer.Builder<Block, BlockState> builder) {
        ...
        builder.add(CON_NORTH, CON_SOUTH, CON_EAST, CON_WEST, OUTPUT_BOTTOM);

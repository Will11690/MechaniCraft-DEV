package com.github.will11690.mechanicraft.blocks.machines.tier2.t2energycube;
...
public class TileEntityT2EnergyCube extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
    ...
    public TileEntityT2EnergyCube() {
    	
        super(TileEntityHandler.TILE_ENTITY_T2_ENERGY_CUBE.get());
	...
	public void onLoad() {
		...
		LazyOptional<T2EnergyCubeNetworkList> t2CubeNetworkCap = level.getCapability(CapabilityT2EnergyCubeNetwork.T2_NETWORK_LIST);
		
		if(t2CubeNetworkCap.isPresent()) {
			T2EnergyCubeNetworkList t2CubeNetwork = t2CubeNetworkCap.orElseThrow(IllegalStateException::new);
			t2CubeNetwork.addConnection(this.worldPosition);
		}
		super.onLoad();
	}
	...
	private void sendPower() {
        ...
        if(energy.get() > 0) {
            ...
            for(Direction direction : Direction.values()) {
                ...
                if(te != null && !(te instanceof TileEntityT2EnergyCube)) {
    ...
    public Container createMenu(int id, PlayerInventory playerInventory, PlayerEntity playerEntity) {
        assert level != null;
        return new ContainerT2EnergyCube(this, id, playerInventory, new CombinedInvWrapper(chargeSlotsHandler, upgradeSlotHandler));
    }
	...
	public ITextComponent getDisplayName() {
		...
		return new TranslationTextComponent("container.mechanicraft.t2_energy_cube");

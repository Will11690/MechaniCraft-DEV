package com.github.will11690.mechanicraft.blocks.machines.tier4.t4energycube;
...
public class ContainerT4EnergyCube extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private TileEntityT4EnergyCube tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT4EnergyCube(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
        this((TileEntityT4EnergyCube) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), id, playerInventory, new ItemStackHandler(10));
        
    }

    public ContainerT4EnergyCube(@Nullable TileEntityT4EnergyCube tile, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
        super(ContainerTypeHandler.CONTAINER_T4_ENERGY_CUBE.get(), id);
        ...
        this.addSlot(new SlotEnergyItem(this.handler, 1, 53, 16));
        
        this.addSlot(new SlotEnergyItem(this.handler, 2, 53, 35));
        
        this.addSlot(new SlotEnergyItem(this.handler, 3, 53, 54));
        
        this.addSlot(new SlotEnergyItem(this.handler, 4, 107, 16));
        
        this.addSlot(new SlotEnergyItem(this.handler, 5, 107, 35));
        
        this.addSlot(new SlotEnergyItem(this.handler, 6, 107, 54));
        
        this.addSlot(new SlotEnergyItem(this.handler, 7, 126, 35));
        
        this.addSlot(new SlotStorageUpgrade(this.handler, 8, 152, 25) {
        ...
        this.addSlot(new SlotStorageUpgrade(this.handler, 9, 152, 45) {

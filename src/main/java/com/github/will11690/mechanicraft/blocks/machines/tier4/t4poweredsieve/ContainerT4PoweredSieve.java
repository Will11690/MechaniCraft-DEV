...
public class ContainerT4PoweredSieve extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT4PoweredSieve tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT4PoweredSieve(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT4PoweredSieve) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(7));
    	
    }
    
    public ContainerT4PoweredSieve(@Nullable TileEntityT4PoweredSieve tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T4_POWERED_SIEVE.get(), id);
        ...
        this.addSlot(new SlotUpgrade(this.handler, 1, 153, 42) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 3, 62, 24) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT4PoweredSieve.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 62, 43) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT4PoweredSieve.isRecipeInput2(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 122, 24) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 6, 122, 48) {

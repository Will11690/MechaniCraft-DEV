...
public class ContainerT5PoweredSieve extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT5PoweredSieve tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT5PoweredSieve(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT5PoweredSieve) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(8));
    	
    }
    
    public ContainerT5PoweredSieve(@Nullable TileEntityT5PoweredSieve tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T5_POWERED_SIEVE.get(), id);
        ...
        this.addSlot(new SlotUpgrade(this.handler, 0, 153, 4) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 1, 153, 24) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 2, 153, 44) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 62, 24) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT5PoweredSieve.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 62, 43) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT5PoweredSieve.isRecipeInput2(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 6, 122, 24) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 7, 122, 48) {

...
public class ContainerT1OreWasher extends Container {
    ...
    public ContainerT1OreWasher(@Nullable TileEntityT1OreWasher tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T1_ORE_WASHER.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 1, 71, 31) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT1OreWasher.isRecipeInputStack(tile.getLevel(), stack)) {

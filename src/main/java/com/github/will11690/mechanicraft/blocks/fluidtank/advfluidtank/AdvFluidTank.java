...
public class AdvFluidTank extends Block {
	...
	TileEntityAdvFluidTank tile;
	
	public AdvFluidTank(Properties properties) {
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        ...
        return TileEntityHandler.TILE_ENTITY_ADVANCED_FLUID_TANK.get().create();
    ...
    public ActionResultType use(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult result) {
    	...
    	if (!world.isClientSide) {
            ...
            tile = (TileEntityAdvFluidTank) world.getBlockEntity(pos);

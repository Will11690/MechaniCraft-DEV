...
public class ContainerT5OreWasher extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT5OreWasher tile;
    ...
    public ContainerT5OreWasher(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT5OreWasher) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(5));
    	
    }
    
    public ContainerT5OreWasher(@Nullable TileEntityT5OreWasher tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T5_ORE_WASHER.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 71, 31) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT5OreWasher.isRecipeInputStack(tile.getLevel(), stack)) {
    ...
    private IFluidHandler getFluid2() {
    	...
    	return tile.getCapability(CapabilityFluidHandler.FLUID_HANDLER_CAPABILITY, tile.getBlockState().getValue(T5OreWasher.FACING).getOpposite()).orElse(null);
    }

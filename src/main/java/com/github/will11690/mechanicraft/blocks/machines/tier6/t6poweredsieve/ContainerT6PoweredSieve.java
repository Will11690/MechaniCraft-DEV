...
public class ContainerT6PoweredSieve extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT6PoweredSieve tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT6PoweredSieve(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
    	this((TileEntityT6PoweredSieve) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(9));
    	
    }
    
    public ContainerT6PoweredSieve(@Nullable TileEntityT6PoweredSieve tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T6_POWERED_SIEVE.get(), id);
        ...
        this.addSlot(new SlotUpgrade(this.handler, 3, 153, 64) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 62, 24) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT6PoweredSieve.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 6, 62, 43) {
        	
            @Override
            public boolean mayPlace(ItemStack stack) {
            	
            	if(TileEntityT6PoweredSieve.isRecipeInput2(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 7, 122, 24) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 8, 122, 48) {

...
public class ContainerT6EnergyCube extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private TileEntityT6EnergyCube tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT6EnergyCube(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
        this((TileEntityT6EnergyCube) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), id, playerInventory, new ItemStackHandler(15));
        
    }

    public ContainerT6EnergyCube(@Nullable TileEntityT6EnergyCube tile, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
        super(ContainerTypeHandler.CONTAINER_T6_ENERGY_CUBE.get(), id);
        ...
        this.addSlot(new SlotEnergyItem(this.handler, 0, 34, 16));
        
        this.addSlot(new SlotEnergyItem(this.handler, 1, 34, 35));

        this.addSlot(new SlotEnergyItem(this.handler, 2, 34, 54));

        this.addSlot(new SlotEnergyItem(this.handler, 3, 53, 16));
        
        this.addSlot(new SlotEnergyItem(this.handler, 4, 53, 35));
        
        this.addSlot(new SlotEnergyItem(this.handler, 5, 53, 54));
        
        this.addSlot(new SlotEnergyItem(this.handler, 6, 107, 16));
        
        this.addSlot(new SlotEnergyItem(this.handler, 7, 107, 35));
        
        this.addSlot(new SlotEnergyItem(this.handler, 8, 107, 54));
        
        this.addSlot(new SlotEnergyItem(this.handler, 9, 126, 16));
        
        this.addSlot(new SlotEnergyItem(this.handler, 10, 126, 35));
        
        this.addSlot(new SlotEnergyItem(this.handler, 11, 126, 54));
        
        this.addSlot(new SlotStorageUpgrade(this.handler, 12, 152, 15) {
        ...
        this.addSlot(new SlotStorageUpgrade(this.handler, 13, 152, 35) {
        ...
        this.addSlot(new SlotStorageUpgrade(this.handler, 14, 152, 55) {

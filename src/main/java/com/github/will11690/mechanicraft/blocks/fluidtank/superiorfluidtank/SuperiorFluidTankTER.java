...
@OnlyIn(Dist.CLIENT)
public class SuperiorFluidTankTER extends TileEntityRenderer<TileEntitySuperiorFluidTank> {

	public SuperiorFluidTankTER(TileEntityRendererDispatcher dispatcher) {
	...
	@Override
	public void render(TileEntitySuperiorFluidTank tank, float partialTicks, MatrixStack matrixStack, IRenderTypeBuffer renderBuffer, int combinedLight, int combinedOverlay) {

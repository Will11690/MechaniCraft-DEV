package com.github.will11690.mechanicraft.blocks.machines.tier4.t4press;
...
public class ContainerT4Press extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT4Press tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT4Press(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
        this((TileEntityT4Press) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(13));
        
    }

    public ContainerT4Press(@Nullable TileEntityT4Press tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T4_PRESS.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 1, 34, 15) {
        	...
        	public boolean mayPlace(ItemStack stack) {
        		...
        		if(TileEntityT4Press.isRecipeInput1(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 2, 54, 11) {
        	...
        	public boolean mayPlace(ItemStack stack) {
        		...
        		if(TileEntityT4Press.isRecipeInput2(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 3, 74, 15) {
        	...
        	public boolean mayPlace(ItemStack stack) {
        		...
        		if(TileEntityT4Press.isRecipeInput3(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 4, 78, 35) {
        	...
        	public boolean mayPlace(ItemStack stack) {
        		...
        		if(TileEntityT4Press.isRecipeInput4(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 74, 55) {
        	...
        	public boolean mayPlace(ItemStack stack) {
        		...
        		if(TileEntityT4Press.isRecipeInput5(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 6, 54, 59) {
        	...
        	public boolean mayPlace(ItemStack stack) {
        		...
        		if(TileEntityT4Press.isRecipeInput6(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 7, 34, 55) {
        	...
        	public boolean mayPlace(ItemStack stack) {
        		...
        		if(TileEntityT4Press.isRecipeInput7(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 8, 30, 35) {
        	...
        	public boolean mayPlace(ItemStack stack) {
        		...
        		if(TileEntityT4Press.isRecipeInput8(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 9, 54, 35) {
        	...
        	public boolean mayPlace(ItemStack stack) {
        		...
        		if(TileEntityT4Press.isRecipeInput9(tile.getLevel(), stack)) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 10, 152, 24) {
        ...
        this.addSlot(new SlotUpgrade(this.handler, 11, 152, 44) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 12, 127, 36) {

...
public class ContainerT5Crusher  extends Container {
	
	private final IItemHandler playerInventory;
	private PlayerEntity player;
    private IItemHandler handler;
    private IIntArray fields;
    private TileEntityT5Crusher tile;
    private int energyStored;
    private int energyCapacity;

    public ContainerT5Crusher(int id, PlayerInventory playerInventory, PacketBuffer exData) {
    	
        this((TileEntityT5Crusher) playerInventory.player.level.getBlockEntity(exData.readBlockPos()), new IntArray(2), id, playerInventory, new ItemStackHandler(7));
        
    }

    public ContainerT5Crusher(@Nullable TileEntityT5Crusher tile, IIntArray fields, int id, PlayerInventory playerInventory, IItemHandler iItemHandler) {
    	
        super(ContainerTypeHandler.CONTAINER_T5_CRUSHER.get(), id);
        ...
        this.addSlot(new SlotItemHandler(this.handler, 1, 50, 32) {
        	...
        	public boolean mayPlace(ItemStack input) {
        		...
        		Optional<CrusherRecipes> recipe = TileEntityT5Crusher.getRecipeForInput(tile.getLevel(), input);
        		
        		if(recipe.isPresent() && !(ItemStack.matches(TileEntityT5Crusher.getResultForItem(tile.getLevel(), input), input))) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 5, 116, 32) {
        ...
        this.addSlot(new SlotItemHandler(this.handler, 6, 116, 56) {
